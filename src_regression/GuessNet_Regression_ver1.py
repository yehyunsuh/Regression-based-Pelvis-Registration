...
if __name__ == "__main__":
    ...
    parser.add_argument("--vis_dir", type=str, default="GuessNet_Regression_baseline_ver1", help="Path to the visualization directory")
    parser.add_argument("--model_dir", type=str, default="../model_weights", help="Path to save the model directory")
    parser.add_argument("--model_name", type=str, default="GuessNet_Regression_baseline_ver1.pth", help="Path to save the model")
