...
def main(args, DEVICE):
    ...
    model = RegressionModel(model_name=args.model, num_outputs=6, pe_channels=(pe_channels+2)).to(DEVICE)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vis_dir", type=str, default="GuessNet_Regression_baseline_ver1_PE_AC", help="Path to the visualization directory")
    parser.add_argument("--model_dir", type=str, default="../model_weights", help="Path to save the model directory")
    parser.add_argument("--model_name", type=str, default="GuessNet_Regression_baseline_ver1_PE_AC.pth", help="Path to save the model")
