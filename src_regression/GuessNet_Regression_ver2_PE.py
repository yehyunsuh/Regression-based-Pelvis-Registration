...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_baseline = torch.cat([image_baseline, pos_embedding], dim=0)
...
def main(args, DEVICE):
    ...
    train_dataset = CustomDataset(train_image_path_list, transform=transform, pe_channels=pe_channels)
    test_dataset = CustomDataset(test_image_path_list, transform=transform, pe_channels=pe_channels)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vis_dir", type=str, default="GuessNet_Regression_baseline_ver2_PE", help="Path to the visualization directory")
    parser.add_argument("--model_dir", type=str, default="../model_weights", help="Path to save the model directory")
    parser.add_argument("--model_name", type=str, default="GuessNet_Regression_baseline_ver2_PE.pth", help="Path to save the model")
